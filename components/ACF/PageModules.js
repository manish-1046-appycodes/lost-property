...
const ModuleBlockquote = dynamic(() =>
  import("../Blockquote/ModuleBlockquote")
);
const ModuleMarquee = dynamic(() => import("../Marquee/ModuleMarquee"));
const ModuleAccordionRooms = dynamic(() =>
  import("../Accordion/ModuleAccordionRooms")
);
...
const ModuleFoodCarousel = dynamic(() =>
  import("../FoodDrinkCarousel/ModuleFoodDrinkCarousel")
);
const ModuleAccordionMenu = dynamic(() =>
  import("../Accordion/ModuleAccordionMenu")
);
const OpenTableWidget = dynamic(() =>
  import("../OpenTableWidget/OpenTableWidget")
);
        ...
        pageModules.map((pageModule, i) => {
          switch (pageModule.fieldGroupName) {
            ...
            case `${upper}_Pagemodules_PageModules_UtilSpacer`:
              return (
                <div key={i} className="spacer h-[120px] lg:h-[150px]"></div>
              );
