...
const AccordionRooms = ( {accordionData} ) => {
              ...
              <div className="container">
                ...
                <div className="max-w-1430px mx-auto lg:grid grid-5 gap-4 lg:gap-9 pt-[85px] lg:pt-0 pb-3 lg:pb-9 relative">
                  <div className="col-span-3 lg:py-[130px] mb-8 lg:mb-0 xl:grid gap-x-4 lg:gap-x-9 grid-cols-3">
                    ...
                    <h2 className="uppercase text-[32px] lg:text-[60px] mb-6 lg:mb-16 col-span-3">{row?.content?.title}</h2>

                    <div className="text-12px lg:text-16px md:max-w-[355px]  col-span-2 mb-6" dangerouslySetInnerHTML={ {__html: row?.content?.copy} } />

                    <div className=" mb-8 lg:mb-0">
                      <div className="text-12px lg:text-16px">

                        { row.content.ameneties && 
                        (<>
