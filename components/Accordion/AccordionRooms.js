...
const AccordionRooms = () => {
  ...
  <div className="accordion-row relative min-h-[85px] lg:min-h-[150px] border-t border-black">
    ...
    <div className="container absolute">
      <div className="max-w-1430px mx-auto grid grid-5 gap-4 lg:gap-9  py-2 lg:py-4">
        <div className="lg:pt-4">Penthouse</div>
        <div className="lg:pt-4">2 x King Bed</div>
        <div className="lg:pt-4">Sleeps x4</div>
        <div className="accordion-btn-initial justify-self-end duration-500 ease-in-out">
          <ButtonRound url="#" title="Buy <br/>Tickets" bg="bg-red-1"/>
        </div>
    ...
    <div className="accordion-child h-0 overflow-hidden opacity-0 duration-500 transition-[all] ease-in-out ">
      <div className="container">
        <div className="max-w-1430px mx-auto lg:grid grid-5 gap-4 lg:gap-9 pt-[85px] lg:pt-0 pb-2 lg:pb-9">
          <div className="col-span-2 lg:pt-[150px] mb-8 lg:mb-0">
            <div className="text-12px lg:text-16px md:max-w-[355px] ">
              <h2 className="uppercase text-[32px] lg:text-[60px] mb-6 lg:mb-16 ">Double</h2>
          ...
          <div className="lg:pt-[150px] mb-8 lg:mb-0">
          ...
          <div className=" w-1/2 lg:w-full lg:pt-9">
