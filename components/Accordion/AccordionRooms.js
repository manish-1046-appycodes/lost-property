...
const AccordionRooms = () => {
  ...
  <div className="accordion-row relative min-h-[85px] lg:min-h-[150px] border-t border-black">
    ...
    <div className="container grid grid-5 gap-4 lg:gap-9 absolute py-2 lg:py-4">
      <div>Penthouse</div>
      <div>2 x King Bed</div>
      <div>Sleeps x4</div>
      <div></div>
    ...
    <div className="accordion-child h-0 overflow-hidden opacity-0 duration-500 transition-[all] ">
      <div className="container lg:grid grid-5 gap-4 lg:gap-9 pt-[85px] lg:pt-0 pb-2 lg:pb-9">
